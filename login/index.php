...
<html lang="de" dir="ltr">
  ...
  <body class="">
    <div class="w3-container">
      <?php
        if ((isset($_POST["Login"])) AND $_POST["Passwort"] == "hallo123") {
          $_SESSION["login"] = true;
        ...
        } elseif ((isset($_POST["Login"])) AND $_POST["Passwort"] != "hallo123") {
      ...
      <form class="w3-margin-bottom" method="post">
        ...
        <input type="text" class="w3-input w3-border w3-light-grey" name="Kennung" placeholder="PD 85 Müller" value="">
        ...
        <br><br>
        <button class="w3-btn w3-block w3-blue" type="submit" onchange="setName()" name="Login">Einloggen</button>
      </form>
    </div>
